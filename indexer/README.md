...
Protos can be found in `proto/` [in the codebase here](https://github.com/dydxprotocol/v4-chain/tree/main/proto).
...
follow the instructions [on this page](https://github.com/dydxprotocol/v4#running-the-chain-locally).
...
You can monitor your local Kafka cluster using Kafka UI.

1. **Start Kafka UI**:

    ```bash
    docker-compose -f docker-compose-local-deployment.yml up -d kafka-ui
    ```
