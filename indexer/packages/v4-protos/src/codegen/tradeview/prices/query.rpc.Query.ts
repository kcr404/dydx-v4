...
export class QueryClientImpl implements Query {
  ...
  marketPrice(request: QueryMarketPriceRequest): Promise<QueryMarketPriceResponse> {
    ...
    const promise = this.rpc.request("tradeview.prices.Query", "MarketPrice", data);
  ...
  allMarketPrices(request: QueryAllMarketPricesRequest = {
    ...
    const promise = this.rpc.request("tradeview.prices.Query", "AllMarketPrices", data);
  ...
  marketParam(request: QueryMarketParamRequest): Promise<QueryMarketParamResponse> {
    ...
    const promise = this.rpc.request("tradeview.prices.Query", "MarketParam", data);
  ...
  allMarketParams(request: QueryAllMarketParamsRequest = {
    ...
    const promise = this.rpc.request("tradeview.prices.Query", "AllMarketParams", data);
  ...
  nextMarketId(request: QueryNextMarketIdRequest = {}): Promise<QueryNextMarketIdResponse> {
    ...
    const promise = this.rpc.request("tradeview.prices.Query", "NextMarketId", data);
