...
import { AffiliateModule, BridgeModule, ClobModule, DistributionModule, FeeTierModule, GovV1Module, PerpetualsModule, PricesModule, ProposalStatus, RateLimitModule, RewardsModule, StakingModule, SubaccountsModule, VaultModule } from './proto-includes';
...
export declare class Get {
    ...
    getAuthenticators(address: string): Promise<GetAuthenticatorsResponse>;
    private sendQuery;
}
