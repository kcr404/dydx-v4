import type { ComplianceResponse, ComplianceV2Response, HeightResponse, TimeResponse } from '../types';
...
export default class UtilityClient extends RestClient {
     ...
     * @returns {ComplianceResponse} whether the specified address is restricted
     */
    complianceScreen(address: string): Promise<ComplianceV2Response>;
}
