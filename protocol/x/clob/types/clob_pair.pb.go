...
// source: tradeview/clob/clob_pair.proto
...
func (ClobPair_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bc9a7ea0541c008b, []int{2, 0}
}
...
func (*PerpetualClobMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc9a7ea0541c008b, []int{0}
}
...
func (*SpotClobMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc9a7ea0541c008b, []int{1}
}
...
type ClobPair struct {
	...
	Status                    ClobPair_Status `protobuf:"varint,7,opt,name=status,proto3,enum=tradeview.clob.ClobPair_Status" json:"status,omitempty"`
}
...
func (*ClobPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc9a7ea0541c008b, []int{2}
}
...
func init() {
	proto.RegisterEnum("tradeview.clob.ClobPair_Status", ClobPair_Status_name, ClobPair_Status_value)
	proto.RegisterType((*PerpetualClobMetadata)(nil), "tradeview.clob.PerpetualClobMetadata")
	proto.RegisterType((*SpotClobMetadata)(nil), "tradeview.clob.SpotClobMetadata")
	proto.RegisterType((*ClobPair)(nil), "tradeview.clob.ClobPair")
}

func init() { proto.RegisterFile("tradeview/clob/clob_pair.proto", fileDescriptor_bc9a7ea0541c008b) }

var fileDescriptor_bc9a7ea0541c008b = []byte{
	// 603 bytes of a gzipped FileDescriptorProto
	,
}
