...
sed 's/.*"app_version":.*//g' "/tmp/prod-chain/.tradeview/config/sorted_genesis.json" > "/tmp/prod-chain/.tradeview/config/sorted_genesis.json.stripped"
...
diff_output=$(diff "/tmp/prod-chain/.tradeview/config/sorted_genesis.json.stripped" "/tmp/sample_pregenesis.json.stripped")
