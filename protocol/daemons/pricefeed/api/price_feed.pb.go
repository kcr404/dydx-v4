...
// source: tradeview/daemons/pricefeed/price_feed.proto
...
func (*UpdateMarketPricesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb36ea5f1d7395d4, []int{0}
}
...
func (*UpdateMarketPricesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb36ea5f1d7395d4, []int{1}
}
...
func (*ExchangePrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb36ea5f1d7395d4, []int{2}
}
...
func (*MarketPriceUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb36ea5f1d7395d4, []int{3}
}
...
func init() {
	proto.RegisterType((*UpdateMarketPricesRequest)(nil), "tradeview.daemons.pricefeed.UpdateMarketPricesRequest")
	proto.RegisterType((*UpdateMarketPricesResponse)(nil), "tradeview.daemons.pricefeed.UpdateMarketPricesResponse")
	proto.RegisterType((*ExchangePrice)(nil), "tradeview.daemons.pricefeed.ExchangePrice")
	proto.RegisterType((*MarketPriceUpdate)(nil), "tradeview.daemons.pricefeed.MarketPriceUpdate")
}

func init() {
	proto.RegisterFile("tradeview/daemons/pricefeed/price_feed.proto", fileDescriptor_fb36ea5f1d7395d4)
}

var fileDescriptor_fb36ea5f1d7395d4 = []byte{
	// 441 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *priceFeedServiceClient) UpdateMarketPrices(ctx context.Context, in *UpdateMarketPricesRequest, opts ...grpc.CallOption) (*UpdateMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tradeview.daemons.pricefeed.PriceFeedService/UpdateMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PriceFeedService_UpdateMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tradeview.daemons.pricefeed.PriceFeedService/UpdateMarketPrices",
	}
...
var _PriceFeedService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tradeview.daemons.pricefeed.PriceFeedService",
	...
	Metadata: "tradeview/daemons/pricefeed/price_feed.proto",
}
