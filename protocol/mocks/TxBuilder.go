...
func (_m *TxBuilder) SetFeeAmount(amount sdk.Coins) {
	_m.Called(amount)
}

// SetFeeGranter provides a mock function with given fields: feeGranter
func (_m *TxBuilder) SetFeeGranter(feeGranter sdk.AccAddress) {
	_m.Called(feeGranter)
}

// SetFeePayer provides a mock function with given fields: feePayer
func (_m *TxBuilder) SetFeePayer(feePayer sdk.AccAddress) {
	_m.Called(feePayer)
}
...
func (_m *TxBuilder) SetMsgs(msgs ...sdk.Msg) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(...sdk.Msg) error); ok {
		r0 = rf(msgs...)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *TxBuilder) SetSignatures(signatures ...signingtypes.SignatureV2) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(...signingtypes.SignatureV2) error); ok {
		r0 = rf(signatures...)
	} else {
		r0 = ret.Error(0)
	}
