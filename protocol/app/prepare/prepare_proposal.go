...
func PrepareProposalHandler(
	...
	return func(ctx sdk.Context, req *abci.RequestPrepareProposal) (*abci.ResponsePrepareProposal, error) {
		...
		fmt.Printf("DEBUG: req.Txs=%d, txsWithoutDisallowMsgs=%d\n", len(req.Txs), len(txsWithoutDisallowMsgs))
		otherTxsToInclude, otherTxsRemainder := GetGroupMsgOther(txsWithoutDisallowMsgs, otherBytesAllocated)
		fmt.Printf("DEBUG: otherTxsToInclude=%d, otherTxsRemainder=%d\n", len(otherTxsToInclude), len(otherTxsRemainder))
